...
@section('title',' لوحة التحكم - خدمات تم رفضها')
...
<div class="content">
    <div class="page-header">
       <div class="page-title">
          <h4>قائمة الخدمات التي تم رفضها</h4>
          <h6>عرض/بحث الخدمات التي تم رفضها</h6>
       </div>
    </div>
    <div class="card">
       <div class="card-body">
             ...
             <table class="table  datanew">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$serviceRequest->rejection_reason}}</td>
...
function performAccept(id,reference) {
        confirmAccept('/dashboard/service-requests/accept/'+id,{},'/dashboard/service-requests/rejected');
    }
