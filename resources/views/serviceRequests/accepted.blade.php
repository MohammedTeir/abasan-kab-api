...
@section('title',' لوحة التحكم -  خدمات تم الموافقة عليها  ')
...
<div class="content">
    <div class="page-header">
       <div class="page-title">
          <h4>قائمة الخدمات التي تم الموافقة عليها </h4>
          <h6>عرض/بحث الخدمات التي تم الموافقة عليها</h6>
       </div>
    </div>
    <div class="card">
       <div class="card-body">
...
function performReject(id,reference) {
        confirmReject('/dashboard/service-requests/reject/'+id,{},'/dashboard/service-requests/accepted');
    }
