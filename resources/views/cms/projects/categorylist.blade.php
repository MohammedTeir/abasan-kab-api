...
@section('title',' لوحة التحكم -  تصنيفات المشاريع')
...
<div class="content">
    <div class="page-header">
       <div class="page-title">
          <h4>قائمة تصنيفات المشاريع</h4>
          <h6>عرض/بحث تصنيفات المشاريع</h6>
       </div>
       <div class="page-btn">
 ...
 @include('modals.cms.projects.category.addCategory')
 @include('modals.cms.projects.category.updateCategory')
@endsection
...
<script>
    ...
    function performAdd() {
        ...
        postRequest('/dashboard/project-categories',data,'/dashboard/project-categories');
    }
    ...
    putRequest('/dashboard/project-categories/'+id,updatedData,'/dashboard/project-categories');
}


    function performDelete(id,reference) {
        confirmDeleteRequest('/dashboard/project-categories/'+id,reference,'/dashboard/project-categories');
    }
