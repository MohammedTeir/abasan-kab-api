                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <a class="me-3 confirm-text" onclick="performMarkClosed({{$complaint->id}},this)">
                           <img src="{{asset('assets/img/icons/cancel.svg')}}" alt="img">
                           </a>

                           <a href="{{route('complaints.download-pdf', ['complaint' => $complaint->id])}}">
                            <img src="{{asset('assets/img/icons/download.svg')}}" alt="img">
                            </a>
                        </td>
                    </tr>
...
function performMarkClosed(complaintId) {
    putRequest(`/dashboard/complaints/${complaintId}/mark-closed`,{},'/dashboard/complaints')
